...
export const Your=({prompt} :{prompt: string})=>{
    return (
        <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1 right-0"><span
            ...
            <p className="leading-relaxed"><span className="block font-bold text-gray-700">You </span>{prompt}</p>
        </div>
    )
}